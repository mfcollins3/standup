...
| Security | L61-L81 | Securing App Configuration: encryption, network isolation, private endpoints, managed identities, Entra ID/RBAC, HMAC/auth models for REST, and Azure Policy/compliance controls. |
