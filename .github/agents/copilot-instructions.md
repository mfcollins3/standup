...
- C# 14 / .NET 10.0 + Microsoft.Azure.Functions.Worker 2.51.0, System.IdentityModel.Tokens.Jwt (for RS256 JWT generation), Npgsql.EntityFrameworkCore.PostgreSQL 10.0.1, Azure.Identity 1.13.2 (006-signed-video-urls)
- Azure Database for PostgreSQL Flexible Server (existing), Azure Key Vault (existing — signing key stored here) (006-signed-video-urls)
...
## Recent Changes
- 006-signed-video-urls: Added C# 14 / .NET 10.0 + Microsoft.Azure.Functions.Worker 2.51.0, System.IdentityModel.Tokens.Jwt (for RS256 JWT generation), Npgsql.EntityFrameworkCore.PostgreSQL 10.0.1, Azure.Identity 1.13.2
