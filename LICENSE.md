# Naked Standup License

Copyright 2026 [Michael F. Collins, III](https://michaelfcollins3.dev)

## Software License

Naked Naked Standup Source-Available Temporary License (v0.0.1; March 17, 2026)
...
- "Software" means the Naked Standup product, including its source code, build scripts, configuration, and associated assets contained in this repository.
...
- Use the Software, trademarks, logos, or trade dress of the Naked Standup product or the copyright holder in any way that suggests endorsement or affiliation without prior written permission;
...
### 2. Will the Naked Standup Product Remain Source-Available After Commercialization?

Yes. If in the future, I commercialize the Naked Standup product and begin charging a fee to license the product, the source code for Naked Standup will remain source-available and you will continue to be able to access the latest source code and use your own derivative versions if you have created them.

### 3. Why are you Licensing Naked Standup like this?
