...
param cloudflareSigningKeyId = readEnvironmentVariable('CLOUDFLARE_SIGNING_KEY_ID')
param cloudflareSigningKeyJwk = readEnvironmentVariable('CLOUDFLARE_SIGNING_KEY_JWK')
param cloudflareCustomerCode = readEnvironmentVariable('CLOUDFLARE_CUSTOMER_CODE')
